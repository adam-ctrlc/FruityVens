...
export default function DaySectionHeader({ displayDate, dailyRevenue, dailyProfit }: DaySectionHeaderProps) {
  return (
    <View className="bg-green-50 px-4 py-2 flex-row items-center justify-between border-b border-green-100">
      <ThemedText size="sm" weight="semibold" variant="primary">{displayDate}</ThemedText>
